...
import com.esgi.algoBattle.resolution.domain.exception.*;
...
public class ResolutionExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(NoneActionOrItemSpecifiedException.class)
    public ResponseEntity<String> on(NoneActionOrItemSpecifiedException ex) {
